...
class UpdateShippingSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'trax_pickup_address_id' => ['nullable', 'integer', 'min:1'],
            'trax_shipping_mode_id' => ['required', 'integer', 'min:1', 'max:4'],
            'trax_charges_mode_id' => ['required', 'integer', 'min:3', 'max:4'],
            'trax_item_product_type_id' => ['required', 'integer', 'min:1', 'max:24'],
            'trax_delivery_type_id' => ['required', 'integer', 'min:1', 'max:2'],
            ...
            'courier_accounts.*.api_environment' => ['nullable', 'string', Rule::in(['testing', 'live'])],
