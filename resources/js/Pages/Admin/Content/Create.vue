...
function submit() {
    form.post(route('admin.content-posts.store'));
}
</script>

<template>
    <Head title="Admin — New article" />
    <AdminLayout>
        <AdminPageHeader
            title="New article"
            :breadcrumbs="[{ label: 'Admin', href: route('admin.dashboard') }, { label: 'Journal', href: route('admin.content-posts.index') }, { label: 'New' }]"
        />
        ...
        <form @submit.prevent="submit">
            <FormSection title="Article">
                ...
                <FormField id="post_pillar" label="Pillar keyword" :error="form.errors.pillar_keyword" hint="Example: running shoes">
                    <template #default="{ invalid, describedBy }">
                        <input
                            id="post_pillar"
                ...
                <FormField id="post_publish_at" label="Publish at (optional)" :error="form.errors.published_at">
                    <template #default="{ invalid, describedBy }">
                        <input
                            id="post_publish_at"
